...
var ClickOutsideDirective = /** @class */ (function () {
    ...
    ClickOutsideDirective.prototype.ngOnInit = function () {
        var _this = this;
        this.globalClick = __WEBPACK_IMPORTED_MODULE_1_rxjs_Observable__["a" /* Observable */]
    ...
    ClickOutsideDirective.prototype.isDescendant = function (parent, child) {
        var node = child;
        while (node !== null) {
            if (node === parent) {
                return true;
    ...
    __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["T" /* Output */])('clickOutside'),
...
var DatePicker = /** @class */ (function () {
    ...
    DatePicker.prototype.yearFitsLimit = function (year) {
        var fitFrom = !this.settings.from || year >= +this.settings.from.getFullYear();
        var fitTo = !this.settings.to || year <= +this.settings.to.getFullYear();
        return fitFrom && fitTo;
    };
    DatePicker.prototype.monthFitsLimit = function (month) {
        if (this.yearFitsLimit(this.date.getFullYear())) {
            var tryDate = this.date;
            tryDate.setMonth(month);
            tryDate.setDate(this.getMonthLength(month, this.date.getFullYear()));
            var fitFrom = !this.settings.from || tryDate >= this.settings.from;
            tryDate.setDate(1);
            var fitTo = !this.settings.to || tryDate <= this.settings.to;
            return fitFrom && fitTo;
        }
        return false;
    };
    DatePicker.prototype.dayFitsLimit = function (day) {
    ...
    DatePicker.prototype.setDay = function (evt, type) {
        var ddf = evt.target.getAttribute('data-label');
        var selectedDay = new Date(ddf);
    ...
    DatePicker.prototype.prevMonth = function (e) {
        e.stopPropagation();
        var self = this;
        var prevDate = new Date(this.date);
    ...
    DatePicker.prototype.closepopover = function (close) {
...
module.exports = "<h2 class=\"example-title\">{{title}}</h2>\r\n<div class=\"col-md-6 mr-auto ml-auto dropdown-container\">\r\n    <angular2-date-picker *ngIf=\"settings && date\" [(ngModel)]=\"date\" [settings]=\"settings\" (onDateSelect)=\"onDateSelect($event)\"></angular2-date-picker>\r\n\r\n</div>\r\n"
